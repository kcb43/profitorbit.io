 ...
 * CRUD for saved shipping addresses
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('Shipping addresses API error:', err);
...
async function handlePut(req, res, userId) {
  ...
  const allowed = ['label', 'name', 'company', 'street1', 'street2', 'city', 'state', 'zip', 'country', 'phone', 'email', 'is_default'];
  const updates = {};
